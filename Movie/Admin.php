...
if (isset($_SESSION['username'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_user'])) {
        ...
        echo "<p style='color:orange;'>Password updated successfully.</p>";
    }

    // Fetch all users
    $users = $pdo->query("SELECT id, username, email FROM users")->fetchAll();

    echo "<h3 style='color:#dedbdb;'>Admin Login make changes to Database</h2>";
    echo "<table border='1' cellpadding='10' style='background:#eee; color:#000;'>";
    echo "<tr><th>ID</th><th>Username</th><th>Email</th><th>New Password</th><th>Actions</th></tr>";
    ...
    echo "<p style='color:white;'>Access denied. Only admin can manage users.</p>";
} else {
    echo "<p style='color:white;'>Please log in as admin to manage users.</p>";
}
?>
